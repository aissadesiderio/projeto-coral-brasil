...
| 3.3 | **Aposentar `/api/monitoramento/`** | ⬜ o frontend migrou e não consome mais; o endpoint e o `StatusPredicao` seguem de pé servindo 3 registros de um modelo que não é mais o do projeto. ⚠️ Prende junto `neo4j_seed` e `gerar_relatorio`, que derivam dele |
