    ...
    <section className="py-8 sm:py-10 lg:py-12">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-10 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          <h2 className="text-4xl font-bold tracking-[-0.03em] text-ocean-dark sm:text-heading-xl">
        ...
        {possuiLocais ? (
          ...
          <div className="rounded-[32px] border border-dashed border-ocean-dark/20 bg-white/80 px-6 py-10 text-center text-sm text-slate-500 shadow-sm">
            Buscando dados mais recentes dos recifes monitorados.
          </div>
        ) : (
          <div className="flex min-h-[320px] flex-col items-center justify-center rounded-[32px] border border-dashed border-ocean-dark/20 bg-white/80 px-6 py-12 text-center shadow-sm">
            <div className="rounded-full bg-ocean-light/10 p-4 text-ocean-dark">
              <MapPin size={28} />
            </div>
            <h3 className="mt-5 text-2xl font-semibold text-ocean-dark">
